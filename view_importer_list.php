            ...
            <div class="col-sm-12">
                ...
                <div class="element-wrapper" style="    padding-bottom: 0px;">
                    ...
                    <div class="tasks-header-w">
                        ...
                        <a class="add-task-btn" data-target="#taskModal" data-toggle="modal" href="#"><i class="os-icon os-icon-ui-22"></i><span>Add Importer</span></a>
                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="row-actions">
                                            <a href="view_importer_profile.php"><i class="os-icon os-icon-grid-10"></i>
                                            </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="attached-media-w">
                                        <input class="form-control" placeholder="Enter Phone " type="text" value="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Enter email " type="text" value="">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                        ...
                        <legend><span>Contact Person  </span></legend>

                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Name</label>
                                    <input class="form-control" placeholder="Enter Name " type="text" value="">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
