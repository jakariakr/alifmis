        ...
        -------------------->
            <div class="menu-mobile menu-activated-on-click color-scheme-dark">
                <div class="mm-logo-buttons-w">
                    <a class="mm-logo" href="index.php"><img src="img/logo.png"><span>Alif Motors</span></a>
                    ...
                    <li class="selected has-sub-menu">
                        ...
                        <div class="sub-menu-w">
                            ...
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    <li>
                                        <a href="recovery_collection.php">Add Recovery</a>
                                    </li>


                                    <li>
                                        <a href="add_field_issues.php">Add Field Issues</a>
                                    </li>

                                    <li>
                                        <a href="view_field_issues.php">Review Field Issues</a>
                                    </li>
                                </ul>
                                <ul class="sub-menu">
                                    <li>
                                        <a href="target_sheet.php">Target Sheet</a>
                                    </li>
                                    <li>
                                        <a href="customer_statement.php">Customer Statement</a>
                                    </li>
                                    <li>
                                        <a href="file_transfer.php">File Transfer</a>
                                    </li>
                                </ul>
                        ...
                        <div class="sub-menu-w">
                            ...
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="recovery_report.php">Recovery Report</a>
                                    </li>
                                    <li>
                                        <a href="seized_list.php">Seized List</a>
                                    </li>
                        ...
                        <div class="sub-menu-w">
                            ...
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="recovery_seting.php">Recovery Seting</a>
                                    </li>  
                                       <li>
                                        <a href="bulk_assign_officer.php">Assign Officer</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="sub-menu-w">
                            ...
                            <div class="sub-menu-i">
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="view_customer_list.php">Customer List</a>
                                    </li>

                                    <li>
                                        <a href="view_grantor_list.php">Grantor List</a>
                                    </li>
                                    <li>
                                        <a href="view_broker_list.php">Broker List</a>
                                    </li>
                                ...
                                <li class=" has-sub-menu">
                                    ...
                                    <div class="sub-menu-w">
                                        ...
                                        <div class="sub-menu-i">
                                            <ul class="sub-menu">
                                                <li>
                                                    <a href="vehicle_stock_report.php">Stock Report</a>
                                                </li>
                                                <li>
                                            ...
                                            <li class=" has-sub-menu">
                                                ...
                                                <div class="sub-menu-w">
                                                    ...
                                                    <div class="sub-menu-i">
                                                        <ul class="sub-menu">
                                                            <li>
                                                                <a href="add_new_vehicle.php">Add Purchase</a>
                                                            </li>
                                                            <li>
                                                                <a href="#">Purchase List</a>
                                                            </li>
                                                            <li>
                                                                <a href="view_vehicle_list.php">Vehicle List</a>
                                                            </li>
                                                            <li>
                                                                <a href="#">Purchases return</a>
                                                            </li>
                                                            <li>
                                                ...
                                                <div class="sub-menu-w">
                                                    ...
                                                    <div class="sub-menu-i">
                                                        <ul class="sub-menu">
                                                            ...
                                                            <li>
                                                                <a href="view_employee_list.php">View Employee List</a>
                                                            </li>
                                            ...
                                            <li class=" has-sub-menu">
                                                ...
                                                <div class="sub-menu-w">
                                                    ...
                                                    <div class="sub-menu-i">
                                                        <ul class="sub-menu">
                                                            <li>
                                                                <a href="view_importer_list.php">Importer/Supplier List</a>
                                                            </li>
                                            ...
                                            <li class=" has-sub-menu">
                                                ...
                                                <div class="sub-menu-w">
                                                    ...
                                                    <div class="sub-menu-i">
                                                        <ul class="sub-menu">
                                                            <li>
                                                                <a href="branch.php">Warehouse/Branch </a>
                                                            </li>
